...
import mavi.selpmobileonline.ui.articles.ArticleFragment;
...
public class FetchOtherQr extends AppCompatActivity {
    ...
    public static int mCurrentUen = 1;
    public static String mAlmacen = "V00096";
    private static final String KEY_FRAGMENT_ARTICLES = ArticleFragment.TAG;
